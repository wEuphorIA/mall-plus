...
import com.jzo2o.mall.member.model.dto.StoreDetailDTO;
import com.jzo2o.mall.member.service.StoreDetailService;
import com.jzo2o.mall.order.mapper.BillMapper;
...
import com.jzo2o.mall.order.model.enums.FlowTypeEnum;
...
public class BillServiceImpl extends ServiceImpl<BillMapper, Bill> implements BillService {
    ...
    public void createBill(String storeId, LocalDateTime startTime, LocalDateTime endTime) {
        ...
        //获取结算店铺
        StoreDetailDTO store = storeDetailService.getStoreDetailDTO(storeId);
        Bill bill = new Bill();
...
//       this.createBill(storeId, startTime, endTime);
    ...
    @Override
    public IPage<BillListDTO> billPage(BillSearchParamsDTO billSearchParams) {
        QueryWrapper<BillListDTO> queryWrapper = billSearchParams.queryWrapper();
        return this.baseMapper.queryBillPage(PageUtils.initPage(billSearchParams), queryWrapper);
    }
    ...
    public void download(HttpServletResponse response, String id) {
        ...
        List<StoreFlowPayDownloadDTO> storeFlowList = storeFlowService.getStoreFlowPayDownloadVO(StoreFlowQueryDTO.builder().type(FlowTypeEnum.PAY.name()).bill(bill).build());
        ...
        List<StoreFlowRefundDownloadDTO> storeFlowRefundDownloadVOList = storeFlowService.getStoreFlowRefundDownloadVO(StoreFlowQueryDTO.builder().type(FlowTypeEnum.REFUND.name()).bill(bill).build());
