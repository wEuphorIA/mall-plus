...
public interface OrderMapper extends BaseMapper<Order> {
     ...
     * @param orderSn 订单编号
     */
    @Update({"update oms_order set order_status = #{status} where sn = #{orderSn}"})
    ...
    @Select("SELECT o.sn,o.create_time,o.member_name,o.consignee_name,o.consignee_mobile,o.consignee_address_path,o.consignee_detail," +
            ...
            "o.remark,o.order_status,o.pay_status,o.deliver_status,o.need_receipt,o.store_name FROM oms_order o LEFT JOIN oms_order_item oi " +
            "ON oi.order_sn=o.sn ${ew.customSqlSegment}")
    List<OrderExportDTO> queryExportOrder(@Param(Constants.WRAPPER) Wrapper<OrderSimpleDTO> queryWrapper);
     ...
     * @return 订单支付记录分页
     */
//    @Select("select * from oms_order ${ew.customSqlSegment} ")
//    IPage<PaymentLog> queryPaymentLogs(IPage<PaymentLog> page, @Param(Constants.WRAPPER) Wrapper<PaymentLog> queryWrapper);
    ...
    @Select("select o.sn,o.flow_price,o.create_time,o.order_status,o.pay_status,o.payment_method,o.payment_time,o.member_name,o.store_name as store_name,o.store_id as store_id,o.client_type,o.order_type,o.deliver_status,o.order_promotion_type " +
            ...
            ",GROUP_CONCAT(oi.image SEPARATOR '|') as group_images" +
            ...
            " FROM oms_order o LEFT JOIN oms_order_item AS oi on o.sn = oi.order_sn ${ew.customSqlSegment} ")
    IPage<OrderSimpleDTO> queryByParams(IPage<OrderSimpleDTO> page, @Param(Constants.WRAPPER) Wrapper<OrderSimpleDTO> queryWrapper);
     ...
     */
    @Select("select o.* " +
            " FROM oms_order o INNER JOIN oms_order_item AS oi on o.sn = oi.order_sn ${ew.customSqlSegment} ")
