package com.jzo2o.mall.order.aop;

import com.jzo2o.common.utils.UserContext;
import com.jzo2o.mall.common.enums.UserEnums;
import com.jzo2o.mall.common.model.AuthUser;
import com.jzo2o.mall.common.utils.SpelUtil;
import com.jzo2o.mall.common.utils.ThreadPoolUtil;
...
public class OrderOperationLogAspect {
    ...
    @After("@annotation(com.jzo2o.mall.order.aop.OrderLogPoint)")
    public void doAfter(JoinPoint joinPoint) {
        try {
            ...
            if (authUser != null) {
                ...
                id = authUser.getIdString();
                role = authUser.getRole().getRole();
            }
