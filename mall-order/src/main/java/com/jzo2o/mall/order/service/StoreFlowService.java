...
public interface StoreFlowService extends IService<StoreFlow> {
     ...
     * @return 入账流水
     */
    List<StoreFlowPayDownloadDTO> getStoreFlowPayDownloadVO(StoreFlowQueryDTO storeFlowQueryDTO);
     ...
     * @return 退款流水
     */
    List<StoreFlowRefundDownloadDTO> getStoreFlowRefundDownloadVO(StoreFlowQueryDTO storeFlowQueryDTO);
