...
import com.jzo2o.mall.order.mapper.LogisticsMapper;
...
import com.jzo2o.mall.order.service.plugin.LogisticsPluginFactory;
...
public class LogisticsServiceImpl extends ServiceImpl<LogisticsMapper, Logistics> implements LogisticsService {
    ...
    @Override
    public TracesDTO getLogisticTrack(String logisticsId, String logisticsNo, String phone) {
        try {
    ...
    @Override
    public TracesDTO getLogisticMapTrack(String logisticsId, String logisticsNo, String phone, String from, String to) {
        try {
