...
@Data
public class AfterSaleSearchParamsDTO extends PageVO {
    ...
    public <T> QueryWrapper<T> queryWrapper() {
        ...
        //按买家查询
        if (CharSequenceUtil.equals(authUser.getRole().name(), UserEnums.MEMBER.name())) {
        ...
        if (CharSequenceUtil.equals(authUser.getRole().name(), UserEnums.MANAGER.name())
