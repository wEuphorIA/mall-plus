package com.jzo2o.mall.evaluation.service;
...
public interface MemberEvaluationService extends IService<MemberEvaluation> {
     ...
     * @return 评价分页
     */
    IPage<MemberEvaluation> managerQuery(EvaluationQueryParamsDTO evaluationQueryParams);
     ...
     * @return 评价分页列表
     */
    IPage<MemberEvaluationListDTO> queryPage(EvaluationQueryParamsDTO evaluationQueryParams);
     ...
     * @return 操作状态
     */
    MemberEvaluationAddDTO addMemberEvaluation(MemberEvaluationAddDTO memberEvaluationDTO, Boolean isSelf);
     ...
     * @return 会员评价
     */
    MemberEvaluationDTO queryById(String id);
     ...
     * @return 评价数量数据
     */
    EvaluationNumberDTO getEvaluationNumber(String goodsId);
     ...
     * @return 商品评价数量
     */
    long getEvaluationCount(EvaluationQueryParamsDTO evaluationQueryParams);

    List<Map<String, Object>> memberEvaluationNum(DateTime startDate, DateTime endDate);

    StoreRatingDTO getStoreRatingVO(String storeId, String status);
