package com.jzo2o.mall.evaluation.model.domain;
 ...
 */
@Data
@TableName("oms_member_evaluation")
...
//    @Sensitive(strategy = SensitiveStrategy.PHONE)
    ...
    private Integer descriptionScore;
        ...
        public MemberEvaluation(MemberEvaluationAddDTO memberEvaluationDTO, OrderItem orderItem, Member member, Order order) {
        //复制评价信息
...
//        this.goodsImage = goodsSku.getThumbnail();
        this.goodsImage = orderItem.getImage();
        //设置店铺ID
