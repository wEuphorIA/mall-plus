...
public interface StoreDetailService extends IService<StoreDetail> {
     ...
     * @return 店铺信息VO
     */
    StoreDetailDTO getStoreDetailDTO(String storeId);
     ...
     * @return 店铺信息VO
     */
    StoreDetailDTO getStoreDetailVOByMemberId(String memberId);
...
//     * @return 店铺经营范围
//     */
//    List<StoreManagementCategoryDTO> goodsManagementCategory(String storeId);
     ...
     * @return 店铺其他信息
     */
    StoreLicenceDTO getStoreLicence(String storeId);
