...
public interface FreightTemplateService extends IService<FreightTemplate> {
     ...
     * @return 运费模板列表
     */
    List<FreightTemplateDTO> getFreightTemplateList(String storeId);
     ...
     */
    @Cacheable(key = "#id")
    FreightTemplateDTO getFreightTemplate(String id);
     ...
     * @return 运费模板
     */
    FreightTemplateDTO addFreightTemplate(FreightTemplateDTO freightTemplateVO);
    ...
    FreightTemplateDTO editFreightTemplate(FreightTemplateDTO freightTemplateVO);
