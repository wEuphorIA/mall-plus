...
public interface GoodsService extends IService<Goods> {
     ...
     * @return 商品VO
     */
    GoodsDTO getGoodsVO(String goodsId);
     ...
     * @return 商品分页
     */
    IPage<Goods> queryByParams(GoodsSearchParamsDTO goodsSearchParams);
     ...
     * @return 商品信息
     */
    List<Goods> queryListByParams(GoodsSearchParamsDTO goodsSearchParams);
     ...
     * @param goodsId 商品id
     */
    void sendUpdateStatusMessage(String goodsId,GoodsAuthEnum goodsAuthEnum,GoodsStatusEnum goodsStatusEnum);
