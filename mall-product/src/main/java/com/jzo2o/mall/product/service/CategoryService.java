...
public interface CategoryService extends IService<Category> {
     ...
     * @return 所有的分类，父子关系
     */
    List<CategoryDTO> listAllChildren(String parentId);
     ...
     * @return 所有的分类，父子关系
     */
    List<CategoryDTO> listAllChildren(CategorySearchParamsDTO categorySearchParams);
     ...
     * @return 分类VO列表
     */
    List<CategoryDTO> getStoreCategory(String[] categories);
