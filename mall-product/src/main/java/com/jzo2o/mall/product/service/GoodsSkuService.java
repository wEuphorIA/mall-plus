...
import com.jzo2o.mall.product.model.dto.GoodsOperationDTO;
import com.jzo2o.mall.product.model.dto.GoodsSearchParamsDTO;
import com.jzo2o.mall.product.model.dto.GoodsSkuDTO;
import com.jzo2o.mall.product.model.dto.GoodsSkuStockDTO;
...
public interface GoodsSkuService extends IService<GoodsSku> {
     ...
     * @return 商品sku详情
     */
    Map<String, Object> getSeckillGoodsSkuDetail(String goodsId, String skuId);
     ...
     * @return goodsSku列表
     */
    List<GoodsSkuDTO> getGoodsListByGoodsId(String goodsId);
     ...
     * @return goodsSku列表
     */
    List<GoodsSkuDTO> getGoodsSkuVOList(List<GoodsSku> list);
     ...
     * @return goodsSku列表
     */
    GoodsSkuDTO getGoodsSkuVO(GoodsSku goodsSku);
     ...
     * @return 商品sku信息
     */
    IPage<GoodsSku> getGoodsSkuByPage(GoodsSearchParamsDTO searchParams);
     ...
     * @return 商品sku信息
     */
    List<GoodsSku> getGoodsSkuByList(GoodsSearchParamsDTO searchParams);
     ...
     */
    void updateStocksBatch(List<GoodsSkuStockDTO> goodsSkuStockDTOS);
     ...
     */
    void sendUpdateStockMessage(String orderSn, boolean isRollback);
