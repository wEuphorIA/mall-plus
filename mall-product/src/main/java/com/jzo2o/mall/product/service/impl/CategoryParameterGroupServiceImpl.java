...
import com.jzo2o.mall.product.mapper.CategoryParameterGroupMapper;
...
//    private GoodsService goodsService;
    ...
    @Override
    public List<ParameterGroupDTO> getCategoryParams(String categoryId) {
        //根据id查询参数组
...
//        }
     ...
     * @return 参数组和参数的返回值
     */
    public List<ParameterGroupDTO> convertParamList(List<CategoryParameterGroup> groupList, List<Parameters> paramList) {
        ...
        List<ParameterGroupDTO> resList = new ArrayList<>();
        for (CategoryParameterGroup group : groupList) {
            ParameterGroupDTO groupVo = new ParameterGroupDTO();
